...
df = df.drop(columns=['Headphone Design', 'Accessories Included', 'Inline Remote', 'Sales Package','Type'])
...
df=df.reindex(columns=['product_link','Title', 'Actual_Price', 'Selling_Price', 'Brand', 'Model', 'Colour', 'Form_Factor', 'Connectivity_Type'])
